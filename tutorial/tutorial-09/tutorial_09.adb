...
procedure Tutorial_09 is
   ...
   begin
      ...
      App.My_Docker.Top_Dock ( Gnoga.Gui.Element.Pointer_To_Element_Class'(App.My_Panel'unchecked_Access));

      App.My_Deck.Create (App.My_Docker);
      App.My_Docker.Fill_Dock (Gnoga.Gui.Element.Pointer_To_Element_Class'(App.My_Deck'Unchecked_access));

      App.My_Cards.Create (App.My_Deck);
      App.My_Cards.Border;
      App.My_Deck.Fill_Dock (Gnoga.Gui.Element.Pointer_To_Element_Class'(App.My_Cards'Unchecked_access));
      ...
      App.My_Deck.Top_Dock (Gnoga.Gui.Element.Pointer_To_Element_Class'(App.My_Tabs'Unchecked_access));
